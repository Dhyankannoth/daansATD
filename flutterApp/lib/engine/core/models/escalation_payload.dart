...
class EscalationPayload {
  ...
  EscalationPayload copyWith({
    ...
    return EscalationPayload(
      ...
      cooldownUntil: cooldownUntilIsSet
          ? cooldownUntil
  ...
  factory EscalationPayload.fromJson(Map<String, dynamic> json) {
    return EscalationPayload(
      ...
      triggerType: EscalationTriggerType.fromJson(
      ...
      vitalsSnapshot: VitalsReading.fromJson(
        json['vitals_snapshot'] as Map<String, dynamic>,
      ),
