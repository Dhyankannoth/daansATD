...
import 'package:pulseguard/engine/dsp/resample.dart'
    show binAverage, resampleLinear;
...
void main() {
  ...
  test(
    '72 bpm PPG with 0.25 Hz respiratory modulation resolves RR ~15 with quality 1.0',
    () {
      const fs = 30.0;
      ...
      final intervalResult = dominantRate(
        intervalGrid,
        respHz,
        respBand,
        respStep,
