...
void main() {
  ...
  test('averageBgra8888 recovers a known solid color within +/-2', () {
    ...
    final avg = averager.averageBgra8888(
        bytes: bytes, bytesPerRow: width * 4, width: width, height: height);
  ...
  test('averageBgra8888 saturation fraction counts pixels at/above sat_pixel', () {
  ...
  test('averageYuv420 (planar, pixel stride 1) recovers known RGB within +/-2', () {
    ...
    final yPlane = Uint8List(width * height)..fillRange(0, width * height, 150);
